...
public class TaskStatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rightAnswersTV = v.findViewById(R.id.correlationValue);

        //Toast.makeText(requireContext(), LocalPerson.getTempRightAnswers(), Toast.LENGTH_SHORT).show();
        //rightAnswersTV.setText(rightAnswers);
